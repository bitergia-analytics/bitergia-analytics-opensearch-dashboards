...
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/radar-vis-plugin/releases/download/0.26.0/radar-vis-plugin-0.26.0_2.16.0.zip
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/network-vis-plugin/releases/download/0.26.0/network-vis-plugin-0.26.0_2.16.0.zip
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/dotplot-vis-plugin/releases/download/0.26.0/dotplot-vis-plugin-0.26.0_2.16.0.zip
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/polar-vis-plugin/releases/download/0.26.0/polar-vis-plugin-0.26.0_2.16.0.zip
...
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/bitergia-analytics-plugin/releases/download/0.26.0/bitergia-analytics-plugin-0.26.0_2.16.0.zip
