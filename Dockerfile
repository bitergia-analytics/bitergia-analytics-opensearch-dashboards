...
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/radar-vis-plugin/releases/download/0.37.0-rc.1/radar-vis-plugin-0.37.0_3.2.0.zip
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/network-vis-plugin/releases/download/0.37.0-rc.1/network-vis-plugin-0.37.0_3.2.0.zip
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/dotplot-vis-plugin/releases/download/0.37.0-rc.1/dotplot-vis-plugin-0.37.0_3.2.0.zip
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/polar-vis-plugin/releases/download/0.37.0-rc.1/polar-vis-plugin-0.37.0_3.2.0.zip
...
RUN opensearch-dashboards-plugin install https://github.com/bitergia-analytics/bitergia-analytics-plugin/releases/download/0.37.0-rc.1/bitergia-analytics-plugin-0.37.0_3.2.0.zip
